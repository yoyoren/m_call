...
$uid=(isset($_REQUEST['agentuid']))?$_REQUEST['agentuid']:'';
if($uid!='') setcookie("Callagentsn", $uid, time() + 3600 * 24, "/", "");
if(empty($_COOKIE['Callagentsn'])&&$uid=='')
{
  echo "请登录坐席！";
  exit;
}
...
/* 初始化数据库类 */
require(ROOT_PATH . 'includes/adodb5/adodb.inc.php');
$db = ADONewConnection('mysql'); 
$db->Connect($ms_db_host, $ms_db_user, $ms_db_pass, $ms_db_name);
$ms_db_host = $ms_db_user = $ms_db_pass = $ms_db_name = NULL;
