...
class cls_session
{
    ...
    var $max_life_time  = 18000000; // SESSION 过期时间
    ...
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'C_ID', $session_id = '')
    {
        $this->cls_session($db, $session_table, $session_data_table, $session_name, $session_id);
    }

    function cls_session(&$db, $session_table, $session_data_table, $session_name = 'C_ID', $session_id = '')
    {
    ...
    {
        //echo '1';print_r($GLOBALS['_SESSION']);echo '2';
